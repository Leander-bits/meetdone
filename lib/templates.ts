...
export const templates: MeetingTemplate[] = [
  {
    ...
    defaultTitle: "Atlas launch · Go / No-Go",
    requirements: {
      revision: 1,
      items: [
        req(
        ...
        req("l-product", "speaker", "Maya · Product", { topicId: "l-topic-readiness" }),
        req("l-engineering", "speaker", "Alex · Engineering", { topicId: "l-topic-readiness" }),
        req("l-sales", "speaker", "Jordan · Sales", { topicId: "l-topic-readiness" }),
        req("l-decision", "decision", "Make the final Go / No-Go decision"),
        req("l-action-comms", "action", "Send the launch announcement"),
        req("l-action-monitor", "action", "Publish the launch monitoring checklist"),
        req(
          "l-agenda-1",
          "agenda",
  ...
  },
  {
    ...
    defaultTitle: "Sprint 24 retrospective",
    requirements: {
      revision: 1,
      items: [
        req("r-goal", "goal", "Identify what helped and what slowed delivery"),
        req("r-conclusion", "conclusion", "Agree on the main lesson from the sprint"),
        req("r-topic", "topic", "Delivery successes and friction"),
        req("r-lead", "speaker", "Sam · Team lead", { topicId: "r-topic" }),
        req("r-dev", "speaker", "Lee · Engineering", { topicId: "r-topic" }),
  ...
  },
  {
    ...
    defaultTitle: "Northstar · Customer progress",
    requirements: {
      revision: 1,
      items: [
        ...
        req("c-csm", "speaker", "Taylor · Customer success", { topicId: "c-topic" }),
        req("c-client", "speaker", "Casey · Customer", { topicId: "c-topic" }),
