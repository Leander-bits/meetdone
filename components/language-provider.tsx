...
import { LANGUAGE_KEY, Locale, translate, requirementLabel } from "@/lib/i18n";
...
export function useI18n() {
  ...
  return {
    ...
    label: (r: Requirement) => requirementLabel(locale, r),
    title: (m: Meeting) => (m.builtinTitle ? translate(locale, m.title) : m.title),
